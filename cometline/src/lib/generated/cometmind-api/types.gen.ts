...
export type ListWorkspaceFilesResponse =
	ListWorkspaceFilesResponses[keyof ListWorkspaceFilesResponses];
...
export type ReadWorkspaceFileContentError =
	ReadWorkspaceFileContentErrors[keyof ReadWorkspaceFileContentErrors];
...
export type ReadWorkspaceFileContentResponse =
	ReadWorkspaceFileContentResponses[keyof ReadWorkspaceFileContentResponses];
...
export type WriteWorkspaceFileContentError =
	WriteWorkspaceFileContentErrors[keyof WriteWorkspaceFileContentErrors];
...
export type WriteWorkspaceFileContentResponse =
	WriteWorkspaceFileContentResponses[keyof WriteWorkspaceFileContentResponses];
...
export type ChangeSessionWorkspaceError =
	ChangeSessionWorkspaceErrors[keyof ChangeSessionWorkspaceErrors];
...
export type ChangeSessionWorkspaceResponse =
	ChangeSessionWorkspaceResponses[keyof ChangeSessionWorkspaceResponses];
...
export type PostSessionMessageResponse =
	PostSessionMessageResponses[keyof PostSessionMessageResponses];
...
export type ListChildSessionsResponse =
	ListChildSessionsResponses[keyof ListChildSessionsResponses];
...
export type ReconnectMcpServerResponse =
	ReconnectMcpServerResponses[keyof ReconnectMcpServerResponses];
...
export type GetMemorySettingsResponse =
	GetMemorySettingsResponses[keyof GetMemorySettingsResponses];
...
export type PutMemorySettingsResponse =
	PutMemorySettingsResponses[keyof PutMemorySettingsResponses];
...
export type PurgeArchivedMemoryResponse2 =
	PurgeArchivedMemoryResponses[keyof PurgeArchivedMemoryResponses];
...
export type CompactMemoryPreviewError =
	CompactMemoryPreviewErrors[keyof CompactMemoryPreviewErrors];
...
export type CompactMemoryPreviewResponse2 =
	CompactMemoryPreviewResponses[keyof CompactMemoryPreviewResponses];
...
export type RunStorageRetentionResponse2 =
	RunStorageRetentionResponses[keyof RunStorageRetentionResponses];
